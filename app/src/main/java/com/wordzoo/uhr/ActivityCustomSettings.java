...
public class ActivityCustomSettings extends FragmentActivity implements OnClickListener {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View v, int position, long id) {
                ...
                switch(parentView.getId()) {
                    case R.id.dreiviertel_combo:
                        ifNotCustomTimeState("21:45");
                        ...
                        updateAvailable();
                        break;
                    case R.id.viertel_combo:
                        ifNotCustomTimeState("21:15");
                        if(((TextView)v).getText().equals("viertel nach")) {
                            ...
                            getSettings().setViertel(Settings.Viertel.kein);

                        updateAvailable();
                        break;
                    case R.id.morgen:
                        ifNotCustomTimeState("08:45");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setupSpinners(R.id.dreiviertel_combo, R.array.settings_dreiviertel);
        setupSpinners(R.id.viertel_combo, R.array.settings_viertel);
...
/*
    ...
    */
    ...
    public void loadUI() {
        ...
        //dreiviertel
        Spinner sp = (Spinner) findViewById(R.id.dreiviertel_combo);
        ...
        //viertel
        sp = (Spinner) findViewById(R.id.viertel_combo);
    ...
    public void updateAvailable() {
        ...
        if(getSettings().getDreiviertel() == Settings.Dreiviertel.dreiviertelacht) {
        ...
        if(getSettings().getViertel() == Settings.Viertel.viertelacht) {
